...
export function SiteShell({ children, currentPath }: { children: ReactNode; currentPath: string }) {
  return (
    <div className="min-h-screen">
      <header className="bg-[#eef3f8]">
        <div className="container-page py-6">
          <div className="overflow-hidden rounded-[32px] border border-[#22364f] bg-[#102033] px-6 py-8 text-white shadow-soft sm:px-8">
            <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
              <div>
                ...
                <h1 className="max-w-4xl text-4xl font-semibold tracking-tight sm:text-5xl">中国政府债务追踪平台</h1>
              ...
              <div className="grid gap-3 sm:max-w-sm">
                ...
                <div className="rounded-2xl border border-white/10 bg-white/10 px-4 py-4 text-sm leading-6 text-white">
      ...
      <div className="container-page grid gap-8 lg:grid-cols-[220px_minmax(0,1fr)]">
        <aside className="h-fit lg:sticky lg:top-6">
          <nav className="space-y-1 rounded-[24px] border border-line/70 bg-white/70 p-3 backdrop-blur-sm">
          ...
          <div className="mt-5 rounded-[24px] border border-line/70 bg-white/70 p-4 text-sm text-slate-600 backdrop-blur-sm">
